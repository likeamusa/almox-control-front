...
import { updateApp, saveCaMaterial } from "../../../../store/modules/app/actions";
...
const Ca_material = () => {
    ...
    const handleSave = () => {
        dispatch(saveCaMaterial(cadastroModalData))
    }
